...
const Detail = {
    ...
    data() {
        return {
            conurl: 'project/setup/finance/doSubmitFinance',
            rejectConurl: 'project/setup/finance/doRejectFinance',
            detailConurl: 'project/setup/finance/getFinanceDetail',
            queryParams: {
        ...
        doProcessDetail(){
            if(this.record.process.processcode!=null){
                ...
                processPanel.defaults = {
                    imgconurl: '/project/setup/finance',
                    dataconurl: 'project/setup/finance/doStep',
                    queryParams: {
                        token: this.$store.getters['user/getToken'],
                        processid: this.record.process.id,
                    }
                }
                this.getLinkComponent(`link-content-panel`).getTabContent().addTab({title: '流程记录',name: `setup/finance/detail-edit-${this.record.id}-process`},processPanel)
            }else{
