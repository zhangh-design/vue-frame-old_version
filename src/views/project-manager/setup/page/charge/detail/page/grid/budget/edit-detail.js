...
const Detail = {
    ...
    data(){
        return {
            detailConurl: 'project/setup/charge/getBudget',
            queryParams: {processid: this.setUpApplyEditPanel.curRow.process.id,token: this.$store.getters['user/getToken']},
            defaults: {
                border: false,
                columns: 2,
                width: 400,
    ...
    methods: {
        ...
        initDetailData(){
            this.detailData = [
                ...
                {span: 1,name: 'totalcost',type: 'TextField',disabled: true,link: this.totalcostLink,readonly:true,width: 200,label: '总成本(万)',emptyText: '后端计算，无需填写'},
            ]
        },
    }
}
