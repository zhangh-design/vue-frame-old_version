...
const Detail = {
    ...
    data(){
        return {
            conurl: 'project/setup/apply/updateHr',
            detailConurl: 'project/setup/apply/getApplyHrDetail',
            queryParams: {
    ...
    methods: {
        ...
        initDetailData(){
            this.detailData = [
                ...
                {span: 1,name: 'begintime',type: 'DateTimePicker',width: 180,label: '计划入场时间',rule: [
                    {required: true,message: '请选择计划入场时间', trigger: 'blur'},
                ]},
                {span: 1,name: 'endtime',type: 'DateTimePicker',width: 180,label: '计划退场时间',rule: [
                ...
                {span: 1,name: 'id',type: 'TextHidden',width: 180},
            ]
        },
