...
const Detail = {
    ...
    data(){
        return {
            conurl: 'project/setup/leader/doSubmitLeader',
            rejectConurl: 'project/setup/leader/doRejectLeader',
            detailConurl: 'project/setup/leader/getLeaderDetail',
            queryParams: {
        ...
        doProcessDetail(){
            if(this.record.process.processcode!=null){
                ...
                processPanel.defaults = {
                    imgconurl: 'project/setup/leader',
                    dataconurl: 'project/setup/leader/doStep',
                    queryParams: {
                        token: this.$store.getters['user/getToken'],
                        processid: this.record.process.id,
                    }
                }
                this.getLinkComponent(`link-content-panel`).getTabContent().addTab({title: '流程记录',name: `setup/leader/detail-edit-${this.record.id}-process`},processPanel)
            }else{
