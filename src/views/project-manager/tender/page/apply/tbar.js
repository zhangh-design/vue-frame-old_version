    ...
    methods: {
        ...
        doDelete() {
            ...
            this.$confirm('此操作将永久删除该记录, 是否继续?', '提示', {
                ...
                this.$api['project/tender/apply/deleteApply']({
        ...
        readDetail(){
            ...
            if(this.record.process.processcode!=null){
                ...
                this.getLinkComponent(`link-content-panel`).getTabContent().addTab({title: '流程记录',name: `tender/apply/detail-edit-${this.record.id}-process`},processPanel)
            }else{
