...
const Tbar = {
    ...
    methods: {
        doDown(){
            ...
            a.href = `${ajaxBaseURL}/project/tender/query/detail/${detailID}/bids?name=${fileName}&token=${this.$store.getters['user/getToken']}`;
            a.download = "download";
            a.click(); */
            window.open(`${ajaxBaseURL}/project/tender/query/detail/${detailID}/bids?name=${encodeURIComponent(fileName)}&token=${this.$store.getters['user/getToken']}`, '_self');
