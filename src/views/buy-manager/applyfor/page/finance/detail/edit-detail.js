...
const Detail = {
    ...
    data() {
        return {
            conurl: 'buy/applyfor/finance/doSubmitFinance',
            rejectConurl: 'buy/applyfor/finance/doRejectFinance',
            detailConurl: 'buy/applyfor/finance/getDetail',
            queryParams: {
    ...
    methods: {
        doProcessDetail(){
            if(this.record.process.processcode!=null){
                ...
                this.getLinkComponent(`link-content-panel`).getTabContent().addTab({title: '流程记录',name: `buy/applyfor/finance/detail-edit-${this.record.id}-process`},processPanel)
            }else{
