...
const Detail = {
    ...
    data() {
        return {
            conurl: 'buy/contract/manager/doSubmitManager',
            rejectConurl: 'buy/contract/manager/doRejectManager',
            detailConurl: 'buy/contract/manager/getDetail',
        ...
        doProcessDetail(){
            if(this.record.process.processcode!=null){
                ...
                processPanel.defaults = {
                    imgconurl: 'buy/contract/manager',
                    dataconurl: `buy/contract/manager/doStep`,
                    queryParams: {
                        token: this.$store.getters['user/getToken'],
                        processid: this.record.process.id,
                    }
                }
                this.getLinkComponent(`link-content-panel`).getTabContent().addTab({title: '流程记录',name: `buy/contract/manager/detail-edit-${this.record.id}-process`},processPanel)
            }else{
