...
const Detail = {
    ...
    data() {
        return {
            conurl: 'buy/contract/low/doSubmitLow',
            rejectConurl: 'buy/contract/low/doRejectLow',
            detailConurl: 'buy/contract/low/getDetail',
        ...
        doProcessDetail() {
            if (this.record.process.processcode != null) {
                ...
                processPanel.defaults = {
                    imgconurl: 'buy/contract/low',
                    dataconurl: `buy/contract/low/doStep`,
                    queryParams: {
                        token: this.$store.getters['user/getToken'],
                ...
                this.getLinkComponent(`link-content-panel`).getTabContent().addTab({
                    title: '流程记录',
                    name: `buy/contract/low/detail-edit-${this.record.id}-process`
                }, processPanel)
            } else {
