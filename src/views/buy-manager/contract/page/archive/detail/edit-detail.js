...
const Detail = {
    ...
    data() {
        return {
            conurl: 'buy/contract/archive/doSubmitArchive',
            rejectConurl: 'buy/contract/archive/doRejectArchive',
            detailConurl: 'buy/contract/archive/getDetail',
        ...
        doProcessDetail() {
            if (this.record.process.processcode != null) {
                ...
                processPanel.defaults = {
                    imgconurl: 'buy/contract/archive',
                    dataconurl: `buy/contract/archive/doStep`,
                    queryParams: {
                        token: this.$store.getters['user/getToken'],
                ...
                this.getLinkComponent(`link-content-panel`).getTabContent().addTab({
                    title: '流程记录',
                    name: `buy/contract/archive/detail-edit-${this.record.id}-process`
                }, processPanel)
            } else {
