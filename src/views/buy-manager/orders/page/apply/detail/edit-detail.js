 ...
 * 编辑详情页
 */
import { CompareObj,applyIn } from '@/utils/tools'
...
const Detail = {
    ...
    data(){
        return {
            conurl: 'buy/orders/apply/doSubmitApply',
            saveConurl: 'buy/orders/apply/doSaveApply',
            detailConurl: 'buy/orders/apply/getApplyDetail',
            queryParams: {
    ...
    created(){
        ...
        this.$on(this.events.afterFormRender,()=>{
            ...
            applyIn(this.formParams,this.record)
        })
    },
    mounted(){},
    methods: {
