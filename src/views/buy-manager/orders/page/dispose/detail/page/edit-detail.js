...
const Detail = {
    ...
    data(){
        return{
            conurl: 'buy/orders/dispose/updateDetail',
            detailConurl: 'buy/orders/dispose/getPackDetail',
            queryParams: {
    ...
    methods: {
        initDetailData(){
            this.detailData = [
                ...
                {span: 1,name: 'num',type: 'TextField',label: '数量',width: 200,disabled:true},
                {span: 1,name: 'amount',type: 'TextField',width: 200,label: '预算单价(元)',disabled:true},
                {span: 1,name: 'payamount',type: 'TextField',width: 200,label: '实际单价(元)',rule:[{required: true,message: '请输入实际单价(元)', trigger: 'blur'},]},
                ...
                {span: 1,name: 'remark',label: '要求',type: 'TextField',width: 200,disabled:true}
            ]
        },
