...
const Detail = {
    ...
    data(){
        return {
            conurl: 'buy/orders/confirm/doSubmitConfirm',
            saveConurl: 'buy/orders/confirm/doSaveConfirm',
            detailConurl: 'buy/orders/confirm/getConfirmDetail',
            queryParams: {
    ...
    methods: {
        ...
        initDetailData(){
            this.detailData = [
                ...
                {span: 1,name: 'invoicetime',type: 'DateTimePicker',fieldStyle:'margin-top:40px;margin-left:-280px;',labelWidth:'110px',width: 148,label: '发票归档时间',rule:[
                    {required: true,message: '请输入采购预算(元)', trigger: 'blur'}
                ]},
