...
const SearchPanel = {
    ...
    methods: {
        initDetailData(){
            this.detailData = [
                {span: 1,name: 'name',label: '项目名称',type: 'TextField',width: 150,emptyText: '招标机构'},
                {span: 1,name: 'begintime1',label: '开始时间',type: 'DatePicker',width: 150},
                {span: 1,name: 'begintime2',label: '结束时间',type: 'DatePicker',width: 150},
