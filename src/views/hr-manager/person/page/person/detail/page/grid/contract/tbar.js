...
const Tbar = {
    ...
    methods: {
        doAdd(){
            let detailWin = new tjWindow({panel: this,mainGrid: this.getPanel,title: '合同信息-添加',height: 230,width: 640})
        ...
        doDelete(){
            ...
            this.$confirm('此操作将永久删除该记录, 是否继续?', '提示', {
                ...
                this.$api['hr/person/person/deleteContract']({id: processID,contractid: this.record.id,token: this.$store.getters['user/getToken']}).then(resData=>{
