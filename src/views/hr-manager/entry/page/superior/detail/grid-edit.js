...
const Detail = {
    ...
    data(){
        return {
            you:'aaaaaaaaa',
            saveConurl: 'hr/entry/superior/updateDetail',
            detailConurl: 'hr/entry/superior/getDetail',
            queryParams: {
    ...
    created(){
        this.$on(this.events.afterFormRender,()=>{
            ...
            this.formParams.personname = this.record.name
            this.formParams.id = this.record.payid
        })
    },
    methods: {
        initButtons(){
        ...
        initDetailData(){
            this.detailData = [
                {span: 1,name: 'socialbase',type: 'TextField', width: 200,label: '社保基数(元)',rule:[
                    ...
                    {validator: this.checkPaymentNum, trigger: 'blur'}],disabled:true},
                ...
                {span: 1,name: 'changedtime',type: 'DatePicker',width: 200,label: '变更日期',rule:[{required: true,message: '请输入变更日期', trigger: 'blur'}],disabled:true},
                {span: 1,name: 'reason',type: 'TextField',width: 200,label: '变更原因',disabled:true},
                {span: 1,name: 'remark',type: 'TextField',width: 200,label: '备注',disabled:true}
            ]
        },
