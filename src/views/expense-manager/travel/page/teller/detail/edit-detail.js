...
const Detail = {
    ...
    data() {
        return {
            conurl: 'expense/travel/teller/doSubmitTeller',
            rejectConurl: 'expense/travel/teller/doRejectTeller',
            detailConurl: 'expense/travel/teller/getTellerDetail',
            queryParams: {
        ...
        readDetail(){
            if(this.record.process.processcode!=null){
                ...
                processPanel.defaults = {
                    imgconurl: 'expense/travel/teller',
                    dataconurl: 'expense/travel/teller/doStep',
                    queryParams: {
                        token: this.$store.getters['user/getToken'],
                        processid: this.record.process.id,
                    }
                }
                this.getLinkComponent(`link-content-panel`).getTabContent().addTab({title: '流程记录',name: `travel/teller/detail-edit-${this.record.id}-process`},processPanel)
            }else{
