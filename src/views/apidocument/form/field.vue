<template>
    <div>
        ...
        <div class="button-group">
            <tj-button-group :buttonGroup="buttonGroup" :border="buttonGroupBorder" :width="buttonGroupWidth" :columns="buttonGroupColumns"></tj-button-group>
        </div>
        <div class="text-area">
        ...
        <div class="combo-box-input">
            <tj-combo-box-input conurl="dict/readProjectsort" :queryParams= comboInputParams.queryParams v-model="comboInputParams.valueInput" :value="comboInputParams.value_in" displayField="name"></tj-combo-box-input>
...
export default {
    ...
    data(){
        return {
            ...
            buttonGroupWidth: 220,
            buttonGroupColumns: 3,
            buttonGroupBorder: true,
			buttonGroup: [
				{text: '提交'},
				{text: '打印123'},
				{text: '分析'},
