...
export default {
    ...
    methods: {
		createDetailData(){
			return [
				{span: 1,name: 'part',value: this.partName,required: true,link: 'aaaaaabb',label: '活动名称',type: 'TextField',width: 170,emptyText: '活动名称',
					rule: [
						{required: true,message: '请输入活动名称', trigger: 'blur'},
						// {min: 3, max: 5, message: '长度在 3 到 5 个字符', trigger: 'blur'},
				...
				{span: 1,name: 'vehicle',displayField:'name',valueField:'id',value: this.treeValue,defaultCheckedKeys:this.defaultCheckedKeys,label: '交通工具',type: 'ComboTree',returnType:'string',multiple: true,expanded: false,width: 170,emptyText: '交通工具',conurl: 'user/readRoleMenus',queryParams: {syscode: 'oa',token: 'a70ea1f3-567a-4cc9-9183-a3c1a8f38cb3'},
					listeners: {
						change: (data)=>{
