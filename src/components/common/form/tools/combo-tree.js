                ...
                props: {
                    ...
                    listeners: {
                        ...
                        checkChange: (record, checked, childCheckNodes)=>{
                            if(!record.hasOwnProperty('node')){
                                return
                            }
                            if(this.curSelectValue.includes(record.node[this.displayField]) && !checked){
                                this.curSelectValue.splice(this.curSelectValue.findIndex(value => value === record.node[this.displayField]),1)
                            }
                        }
                    }
                },
